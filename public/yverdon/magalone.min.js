    ...
    var t = {
            ...
            _trigger: function(t, i) {
                ...
                if (this._subscribers[t])
                    for (u = this._subscribers[t], r = 0; r < u.length; r++)
                        f = u[r],
                        f.apply(n, i)
            },
            ...
            random: {
                _gen: function(n) {
                    for (var r = n.upper || 65, i = n.lower || 90, u = n.len || n.length || 8, t = ""; t.length < u;)
                        t += Math.random() * 100 >= 50 ? String.fromCharCode(Math.floor(Math.random() * (r - i) + i)) : Math.floor(Math.random() * 9).toString();
                    return t
                },
                number: function(n, t) {
                        ...
                        i = function(n) {
                            ...
                            for (u in n)
                                if (r = n[u], t.isString(r)) {
                                    if (n[u] = r = r.trim(), r.trim().length == 0)
                                        return n.splice(u, 1), i(n)
            ...
            color: {
                ...
                HSVToRGB: function(n, t, i) {
                    var r,
                        ...
                        o,
                        s;
                    if (n = Math.max(0, Math.min(360, n)), t = Math.max(0, Math.min(100, t)), i = Math.max(0, Math.min(100, i)), t /= 100, i /= 100, t == 0)
                        return r = u = f = i, [Math.round(r * 255), Math.round(u * 255), Math.round(f * 255)];
                    n /= 60;
                    h = Math.floor(n);
                    c = n - h;
                    e = i * (1 - t);
                ...
                Saturate: function(n, i) {
                    var u = 0,
                        f = i || 100,
                        r;
                    if (t.is.object(n) ? n.h && n.s && n.v ? u = "HSV" : n.r && n.g && n.b && (u = "RGB") : n.startsWith("#") && (u = "HEX"), u === 0)
                        return n;
                    r = 0;
                    switch (u) {
                    case "HSV":
            ...
            cookies: {
                ...
                Read: function() {
                    var r,
                        ...
                        i,
                        u;
                    for (this.cookies = [], r = document.cookie, t = r.split(";"), n = 0; n < t.length; n++)
                        i = t[n].split("="),
                        u = {
                            name: i[0],
                            value: i[1]
                ...
                Clear: function() {
                    this.Read();
                    for (var n = 0; n < this.cookies.length; n++)
                        $cookie = this.cookies[n],
                ...
                request: function(n, t) {
                    ...
                    i.data && i.method == "POST" ? (u = "", f = function(n, t) {
                        var e = [],
                            ...
                            r;
                        for (i in n)
                            n.hasOwnProperty(i) && (u = t ? t + "[" + i + "]" : i, r = n[i], e.push(typeof r == "object" ? f(r, u) : encodeURIComponent(u) + "=" + encodeURIComponent(r)));
                        return e.join("&")
            ...
            browserNotification: {
                ...
                _list: [],
                Init: function() {
                    if (this.Check_Support(!0))
                        switch (this.Permission.Check(!0)) {
...
function InitExHelp_ElementPlugin(n) {
    if (n.exHelp == void 0 || n.exHelpExtend == void 0)
        return setTimeout(InitExHelp_ElementPlugin, 100, n);
    var t = function(n, i) {
    ...
    t.functions = t.prototype = {
        ...
        init: function(i, r) {
            ...
            if (f = [], exHelp.is.string(i)) {
                if (i.charAt(0) == "<" && i.length >= 3 && i.charAt(i.length - 1) == ">")
                    return o = n.document.createElement("div"), o.innerHTML = i, f = o.childNodes, new t(f, r);
                for (f = n.document.querySelectorAll(i), u = 0; u < f.length; u++)
                    this[u] = f[u];
                this.length = f.length
            } else if (exHelp.is.arraylike(i)) {
                for (e = i.length, u = 0; u < e; u++)
                    s = i[u] instanceof exHelp.e ? i[u] : new t(i[u], r),
                    s.length > 0 && f.push(s[0]);
                for (e = f.length, u = 0; u < e; u++)
                    this[u] = f[u];
                this.length = f.length
            } else if (exHelp.is.object(i)) {
                if (i instanceof exHelp.e)
                    return i;
        ...
        children: function() {
            var n = [];
            return this.each(function() {
                for (var t = 0, i = this.childNodes, r = i.length; t < r; t++)
                    n.push(i[t])
            }), new t(n)
        },
        find: function(n) {
        ...
        getParents: function(n) {
            var r = [],
                ...
                u = function(o) {
                    if (o) {
                        var s = new t(o);
                        if (r.push(o), i && (f && s.hasClass(n) || e && s.getAttr("id") == n))
                            return !1;
                        if (o.parentNode)
        ...
        getRelativeXY: function(n) {
            var i = {
                ...
                e = function(n) {
                    var o = new t(n);
                    if (r && o.hasClass(f) || u && o.getAttr("id") == f || !r && !u && o[0].nodeName.toLowerCase() == f.toLowerCase())
                        return !1;
                    i.x += n.offsetLeft;
                    i.y += n.offsetTop;
        ...
        addClass: function(n) {
            var t = n.split(" ");
            return this.each(function() {
                for (var i = this.className.split(" "), n = 0; n < t.length; n++)
                    exHelp.array.contains(i, t[n]) || i.push(t[n]);
        ...
        removeClass: function(n) {
            var t = n.split(" ");
            return this.each(function() {
                for (var n = this.className.split(" "), i = 0; i < t.length; i++)
                    exHelp.array.contains(n, t[i]) && n.splice(n.indexOf(t[i]), 1);
        ...
        toggleClass: function(n) {
            ...
            return this.each(function() {
                for (var n = this.className.split(" "), i = 0; i < t.length; i++)
                    exHelp.array.contains(n, t[i]) ? n.splice(n.indexOf(t[i]), 1) : n.push(t[i]);
                this.className = n.join(" ").trim()
            }), this
        },
        hasClass: function(n) {
        ...
        off: function(n, t) {
            ...
            if (exHelp.is.string(n))
                if (n.contains(" "))
                    ...
                    for (u = n.split(","), i = 0; i < u.length; i++)
                        u[i] = u[i].trim();
                else
                    u.push(n);
...
function InitReader(n) {
    if (n.exHelp == void 0 || n.exHelpExtend == void 0 || n.exHelp.e == void 0)
        return setTimeout(InitReader, 100, n);
    var t = exHelp,
        i = {
            reader: {
                container: null,
                ...
                loadPdfProcessor: function(n) {
                    ...
                    if (f.each(function() {
                        ...
                        var e = t.pager.current_script.substr(0, t.pager.current_script.lastIndexOf("/")),
                            o = e + "/processing" + (t.pager.current_script.contains(".min") ? ".min" : "") + ".js",
                ...
                loadLocale: function(n) {
                    ...
                    if (f.each(function() {
                        ...
                        t.pager.current_script = i;
                        var e = t.pager.current_script.substr(0, t.pager.current_script.lastIndexOf("/")),
                            o = e + "/locale/" + t.reader.settings.language + (t.pager.current_script.contains(".min") ? ".min" : "") + ".js",
                            r = document.createElement("script"),
                            u = !1;
                        r.onload = function() {
                            u || n();
                ...
                prepareControls: function() {
                    var i = {
                        ...
                        f;
                    for (n in i)
                        u = r[this.control_assignments[n]] || r["topleft-hor"],
                        this._prepareElement(i[n], u).setAttr("tabindex", e++);
                    if (this.settings.show_fullscreen) {
                        ...
                        t.e(".ctrl.btn.fullscreen").addClass("gone");
                    if (this.settings.show_overview)
                        t.e(".ctrl.btn.overview").on("click tap", function(n) {
                            n && n.preventDefault && n.preventDefault();
                            n && n.stopPropagation && n.stopPropagation();
                            t.reader.overview.toggle()
                        });
                    else
                        t.e(".ctrl.btn.overview").addClass("gone");
                    if (this.settings.show_invert && !t.browser.isMSIE)
                        t.e(".ctrl.btn.invert").on("click tap", function(n) {
                            n && n.preventDefault && n.preventDefault();
                            n && n.stopPropagation && n.stopPropagation();
                            t.reader.toggleInvert()
                        });
                    else
                        t.e(".ctrl.btn.invert").addClass("gone");
                    if (this.settings.show_zoom) {
                        ...
                        t.e([".ctrl.btn.zoom-in", ".ctrl.btn.zoom-out"]).addClass("gone");
                    if (this.settings.enable_arrows) {
                        ...
                        t.e([".ctrl.btn.go-fwd", ".ctrl.btn.go-back"]).addClass("gone");
                    if (this.settings.show_download)
                        t.e(".ctrl.btn.download").on("click tap", function(n) {
                            n && n.stopPropagation && n.stopPropagation()
                        });
                    else
                        t.e(".ctrl.btn.download").addClass("gone");
                    if (this.settings.show_go_to_page)
                        t.e(".ctrl.btn.goto").on("click tap", function(n) {
                            n && n.preventDefault && n.preventDefault();
                            n && n.stopPropagation && n.stopPropagation()
                        });
                    else
                        t.e(".ctrl.btn.goto").addClass("gone");
                    if (this.settings.slideshow_mode && this.settings.slideshow_controls) {
                        ...
                        t.e([".ctrl.btn.ss-back", ".ctrl.btn.ss-pause", ".ctrl.btn.ss-play", ".ctrl.btn.ss-fwd"]).addClass("gone")
                },
                slideshow: {
                    timeout: null,
                ...
                prepareData: function() {
                    t.net.request(this.path + "/data.json", {
                ...
                prepareElements: function() {
                    for (var n in this.elements)
                        this._prepareElement(this.elements[n], this.container)
                },
                _prepareElement: function(n, i) {
                    ...
                    if (r = i.find(n.selector), r.length == 0 && (r = t.e(n.construct || "<div>", n.options), r.appendTo(i)), n.children !== void 0)
                        for (u in n.children)
                            this._prepareElement(n.children[u], r);
                    return r
                },
                        ...
                        n = {
                            ...
                            load: function(r, u, f) {
                                ...
                                if (r) {
                                    ...
                                    for (n.sources = r, n.spinner.removeClass("hidden"), e = 0; e < n.elements.length; e++)
                                        n.elements[e].remove();
                                    for (n.elements = [], e = 0; e < n.sources.length; e++)
                                        n.elements[e] = t.e("<img>", {
                                            "class": f && e == 0 ? "" : "loading"
                                        }).appendTo(i)
                                }
                                n.callback = u;
            ...
            overlays: {
                ...
                init: function() {
                    ...
                    for (var n = t.reader.container.find(".overlay"), i = 0, r = n.length; i < r; i++)
                        this.parse(n[i]);
                    n.remove()
                },
                ...
                render: function() {
                    ...
                    if (n.lastRenderMode != r.current_mode || n.lastRenderPage != r.current_page || n.lastRenderZoom != r.current_zoom)
                        for (n.lastRenderMode = r.current_mode, n.lastRenderPage = r.current_page, n.lastRenderZoom = r.current_zoom, n.prepare(), n.objects = [], t.pager.current_mode == f.SINGLE ? o = n.container.find(".page") : t.pager.current_mode == f.DOUBLE && (s = n.container.find(".left"), h = n.container.find(".right")); e < c; e++)
                            i = n.elements[e],
                            t.pager.current_mode == f.SINGLE ? i.page == t.pager.current_page && (u = n.make(i).appendTo(o)) : t.pager.current_mode == f.DOUBLE && (i.page == t.pager.current_page_left ? u = n.make(i).appendTo(s) : i.page == t.pager.current_page_right && (u = n.make(i).appendTo(h))),
                            u && n.objects.push(u)
                },
                ...
                make_gallery: function(n) {
                    for (var i, o = t.random.guid(), r = t.e("<div>", {
                            ...
                            "class": "dots"
                        }).appendTo(r), u = [], f = [], s = 0; s < n.length; s++)
                        u.push(t.reader.stageLoader().appendTo(r)),
                        f.push(t.e("<div>", {
                            "class": "dot"
                        }).appendTo(l));
                    i = {
                        gallery: {
                            ...
                            start: function() {
                                ...
                                if (!i.gallery.hasBeenStarted) {
                                    for (i.gallery.hasBeenStarted = !0, t = 0; t < n.length; t++)
                                        r = n[t],
                                        u[t].load([r]);
                                    u[0].addClass("appear");
                                    f[0].addClass("active")
                        ...
                        adjustSize: function(n, f) {
                            if (r.hasClass("open")) {
                                for (var s = r.getRelativeXY(".content"), h = Math.max(n + 16, 200), c = Math.max(f + 8 + 32 + 8, 80), l = t.math.rect(s.y, s.x, s.y + c, s.x + h), e = t.math.rect(s.y, s.x, s.y + c, s.x + h), o = t.overlays.getAvailableSpace(), v = i.y * u, y = i.x * u, p = 0; !o.contains(e);)
                                    if (e.height > o.height && (a = !0, e.height = o.height), e.width > o.width && (a = !0, e.width = o.width), e.top < o.top && e.moveTopTo(o.top), e.left < o.left && e.moveLeftTo(o.left), e.bottom > o.bottom && e.moveTopBy(o.bottom - e.bottom), e.right > o.right && e.moveLeftBy(o.right - e.right), p++ > 10)
                                        break;
                                v += e.top - l.top;
                                y += e.left - l.left;
                                h = e.width;
                ...
                closeAll: function() {
                    for (var n = 0, i = t.overlays.objects.length; n < i; n++)
                        t.overlays.objects[n].close()
                }
            },
            pager: {
                pages: null,
                ...
                get pdf_average_rendertimes() {
                    for (var n = 0, t = 0, i = this.pdf_last_rendertimes.length; n < i; n++)
                        t += this.pdf_last_rendertimes[n];
                    return t / i
                },
                ...
                getFullPath: function(n) {
                    return t.reader.path + "/images/" + this.getFileName(n) + ".jpg"
                },
                getThumbPath: function(n) {
                    return t.reader.path + "/thumbs/" + this.getFileName(n) + ".jpg"
                },
                getPDFPath: function() {
                    return t.reader.path + "/pdf/" + this.getFileName("full") + ".pdf"
                },
                ...
                prepareElements: function() {
                    ...
                    if (this.holders.length == 0)
                        for (r = this.getPageSize(1), n = 0; n < 6; n++)
                            this.holders[n] = t.e("<div>", {
                                "class": "page"
                            }).appendTo(this.page_container),
                            u = t.e("<div>", {
                                "class": "wrapper"
                            }).appendTo(this.holders[n]),
                            this.loaders[n] = t.reader.stageLoader().appendTo(u),
                            t.e("<canvas>", {
                                "class": "loading"
                            }).appendTo(u),
                            this.holders[n].setAttr("style", "width: {0}px; height: {1}px;".format(r.width, r.height));
                    if (this.current_mode == i.SINGLE || this.current_mode == i.SINGLE_REVERSE)
                        for (this.page_container.addClass("single").removeClass("double"), n = 0; n < 6; n++)
                            this.holders[n].removeClass("previous next left right"),
                            n == i.CUR ? this.holders[n].removeClass("hidden previous next") : n == i.PREV ? this.holders[n].removeClass("next").addClass("hidden previous") : n == i.NEXT ? this.holders[n].removeClass("previous").addClass("hidden next") : this.holders[n].addClass("hidden").removeClass("previous next");
                    else if (this.current_mode == i.DOUBLE || this.current_mode == i.DOUBLE_REVERSE)
                        for (this.page_container.addClass("double").removeClass("single"), n = 0; n < 6; n++)
                            n == i.CUR_LEFT || n == i.CUR_RIGHT ? this.holders[n].removeClass("previous next") : n == i.PREV_LEFT || n == i.PREV_RIGHT ? this.holders[n].removeClass("next").addClass("previous") : (n == i.NEXT_LEFT || n == i.NEXT_RIGHT) && this.holders[n].removeClass("previous").addClass("next"),
                            n == i.CUR_LEFT && this.show_page_left ? this.holders[n].removeClass("hidden") : n == i.CUR_RIGHT && this.show_page_right ? this.holders[n].removeClass("hidden") : this.holders[n].addClass("hidden"),
                            n == i.CUR_LEFT || n == i.PREV_LEFT || n == i.NEXT_LEFT ? this.holders[n].addClass("left").removeClass("right") : n == i.CUR_RIGHT || n == i.PREV_RIGHT || n == i.NEXT_RIGHT ? this.holders[n].addClass("right").removeClass("left") : this.holders[n].removeClass("left right")
                },
                preparePdf: function() {
                ...
                loadPdfJsCompat: function(n) {
                    var u = t.pager.current_script.substr(0, t.pager.current_script.lastIndexOf("/")),
                        f = u + "/pdfjs/compatibility" + (t.pager.current_script.contains(".min") ? ".min" : "") + ".js",
                ...
                loadPdfJsMain: function(n) {
                    var u = t.pager.current_script.substr(0, t.pager.current_script.lastIndexOf("/")),
                        f = u + "/pdfjs/pdf" + (t.pager.current_script.contains(".min") ? ".min" : "") + ".js",
                        i = document.createElement("script"),
                        r = !1;
                    i.onload = function() {
                        r || n();
                ...
                goForward: function(n, i) {
                    ...
                    switch (r.current_mode) {
                    case u.SINGLE:
                        if (r.current_page >= r.page_count)
                            return;
                        r.current_page++;
                        break;
                    case u.DOUBLE:
                        if (r.current_page_left >= r.page_count || r.current_page_right >= r.page_count)
                            return;
                        r.current_page += 2
                    }
                    r.goToPage(r.current_page, n, {
                ...
                var u = t.e(n),
                    ...
                    lt = function(n) {
                        if (n.type != "mouseleave") {
                            ...
                            if (!u.getParents().hasClass("ctrl"))
                                if (v) {
                                    if (v = !1, clearTimeout(rt), u.getAttr("id") == d.getAttr("id") && u.getAttr("class") == d.getAttr("class") && i.onDoubleTap && t.is.function(i.onDoubleTap))
                                        i.onDoubleTap(e(n) || f || r)
                                } else
                                    v = !0,
                                    d = u,
                    ...
                    at = function(n) {
                        if (!t.e(n.srcElement).getParents().hasClass("ctrl"))
                            if (t.pager.content_container[0].focus(), n && n.preventDefault && n.preventDefault(), !w && n && n.stopPropagation && n.stopPropagation(), b = n.type.startsWith("touch"), b && n.touches.length >= 2) {
                                if (o = !0, c = s = !1, r = f = e(n), i.onPinchStart && t.is.function(i.onPinchStart))
                                    i.onPinchStart(r)
                            } else
                                y() ? (c = !0, r = e(n)) : (s = !0, f = e(n))
                    },
                    vt = function(n) {
                        var h,
                            c;
                        if (n && n.preventDefault && n.preventDefault(), !w && n && n.stopPropagation && n.stopPropagation(), l || (u.addClass("speed"), l = !0), o) {
                            var h = e(n),
                                c = h.dist - r.dist,
                                a = h.dist / r.dist;
                            if (i.onPinch && t.is.function(i.onPinch))
                                i.onPinch(c, a, h)
                        } else if (!y() && s && (h = e(n), c = {
                            x: f.x - h.x,
                            y: f.y - h.y
                        }, i.onDrag && t.is.function(i.onDrag)))
                            i.onDrag(c);
                        (b || !y()) && (f = e(n))
                    },
                    yt = function(n) {
                        if (n && n.preventDefault && n.preventDefault(), !w && n && n.stopPropagation && n.stopPropagation(), l && (u.removeClass("speed"), l = !1), o || lt(n), y() && c)
                            h = n.type.startsWith("touch") && f != null && f != undefined ? f : e(n) || r,
                            it = t.math.Dist2D(r, h),
                            tt = Math.abs(r.y - h.y),
                            nt = r.x > h.x ? g : ct,
                            it > et && tt < ot && (nt == g ? i.onSwipeLeft && t.is.function(i.onSwipeLeft) && i.onSwipeLeft() : i.onSwipeRight && t.is.function(i.onSwipeRight) && i.onSwipeRight()),
                            c = !1;
                        else if (o) {
                            if (i.onPinchEnd && t.is.function(i.onPinchEnd))
                                i.onPinchEnd(f);
                            o = !1
                        } else
                            s = !1
                    ...
                    pt = function(n) {
                        if (n && n.preventDefault && n.preventDefault(), n && n.stopPropagation && n.stopPropagation(), !o && !s) {
                            if (!a && (a = !0, r = e(n), k = 10, i.onWheelStart && t.is.function(i.onWheelStart)))
                                i.onWheelStart(r);
                            k += p * -ft(n.deltaY);
                            var u = e(n),
                                f = p * ft(n.deltaY),
                                h = k / 10;
                            if (i.onWheel && t.is.function(i.onWheel))
                                i.onWheel(f, h, u);
                            clearTimeout(ut);
                            ut = setTimeout(wt, ht)
                        }
                    ...
                    wt = function() {
                        if (a) {
                            if (i.onWheelEnd && t.is.function(i.onWheelEnd))
                                i.onWheelEnd(r);
                            a = !1
                        }
                    };
            ...
            PDFQueue: {
                ...
                _render: function() {
                    ...
                    if (n)
                        ...
                        i.runnning = !1,
                        i.current_callback && t.is.function(i.current_callback) && i.current_callback()
                }
            },
            PDFManager: {
                DEBUG_SYMBOL: "PDFM",
            ...
            sha1: function(n) {
                var c = function(n, t) {
                    ...
                    e,
                    l;
                for (n = this.utf8_encode(n), e = n.length, l = [], t = 0; t < e - 3; t += 4)
                    d = n.charCodeAt(t) << 24 | n.charCodeAt(t + 1) << 16 | n.charCodeAt(t + 2) << 8 | n.charCodeAt(t + 3),
                    l.push(d);
                switch (e % 4) {
                case 0:
                    t = 2147483648;
                ...
                for (l.push(t); l.length % 16 != 14;)
                    l.push(0);
                for (l.push(e >>> 29), l.push(e << 3 & 4294967295), v = 0; v < l.length; v += 16) {
                    for (t = 0; t < 16; t++)
                        o[t] = l[v + t];
                    for (t = 16; t <= 79; t++)
                        o[t] = c(o[t - 3] ^ o[t - 8] ^ o[t - 14] ^ o[t - 16], 1);
                    for (f = y, i = p, r = w, u = b, s = k, t = 0; t <= 19; t++)
                        h = c(f, 5) + (i & r | ~i & u) + s + o[t] + 1518500249 & 4294967295,
                        s = u,
                        u = r,
                        r = c(i, 30),
                        i = f,
                        f = h;
                    for (t = 20; t <= 39; t++)
                        h = c(f, 5) + (i ^ r ^ u) + s + o[t] + 1859775393 & 4294967295,
                        s = u,
                        u = r,
                        r = c(i, 30),
                        i = f,
                        f = h;
                    for (t = 40; t <= 59; t++)
                        h = c(f, 5) + (i & r | i & u | r & u) + s + o[t] + 2400959708 & 4294967295,
                        s = u,
                        u = r,
                        r = c(i, 30),
                        i = f,
                        f = h;
                    for (t = 60; t <= 79; t++)
                        h = c(f, 5) + (i ^ r ^ u) + s + o[t] + 3395469782 & 4294967295,
                        s = u,
                        u = r,
                        r = c(i, 30),
                        i = f,
            ...
            md5: function(n) {
                ...
                function kt(n) {
                    for (var r, u = n.length, o = u + 8, s = (o - o % 64) / 64, e = (s + 1) * 16, i = Array(e - 1), f = 0, t = 0; t < u;)
                        r = (t - t % 4) / 4,
                        f = t % 4 * 8,
                        i[r] = i[r] | n.charCodeAt(t) << f,
                        t++;
                    return r = (t - t % 4) / 4, f = t % 4 * 8, i[r] = i[r] | 128 << f, i[e - 2] = u << 3, i[e - 1] = u >>> 29, i
                }
                function v(n) {
                    for (var i = "", r = "", u, t = 0; t <= 3; t++)
                        u = n >>> t * 8 & 255,
                        r = "0" + u.toString(16),
                        i = i + r.substr(r.length - 2, 2);
                    return i
                }
                function dt(n) {
                    var i,
                ...
                var e = Array(),
                    ...
                    st = 21,
                    vt;
                for (n = dt(n), e = kt(n), t = 1732584193, i = 4023233417, r = 2562383102, u = 271733878, f = 0; f < e.length; f += 16)
                    ht = t,
                    ct = i,
                    lt = r,
                    at = u,
                    t = s(t, i, r, u, e[f + 0], y, 3614090360),
                    u = s(u, t, i, r, e[f + 1], p, 3905402710),
                    r = s(r, u, t, i, e[f + 2], w, 606105819),
                    i = s(i, r, u, t, e[f + 3], b, 3250441966),
                    t = s(t, i, r, u, e[f + 4], y, 4118548399),
                    u = s(u, t, i, r, e[f + 5], p, 1200080426),
                    r = s(r, u, t, i, e[f + 6], w, 2821735955),
                    i = s(i, r, u, t, e[f + 7], b, 4249261313),
                    t = s(t, i, r, u, e[f + 8], y, 1770035416),
                    u = s(u, t, i, r, e[f + 9], p, 2336552879),
                    r = s(r, u, t, i, e[f + 10], w, 4294925233),
                    i = s(i, r, u, t, e[f + 11], b, 2304563134),
                    t = s(t, i, r, u, e[f + 12], y, 1804603682),
                    u = s(u, t, i, r, e[f + 13], p, 4254626195),
                    r = s(r, u, t, i, e[f + 14], w, 2792965006),
                    i = s(i, r, u, t, e[f + 15], b, 1236535329),
                    t = h(t, i, r, u, e[f + 1], k, 4129170786),
                    u = h(u, t, i, r, e[f + 6], d, 3225465664),
                    r = h(r, u, t, i, e[f + 11], g, 643717713),
                    i = h(i, r, u, t, e[f + 0], nt, 3921069994),
                    t = h(t, i, r, u, e[f + 5], k, 3593408605),
                    u = h(u, t, i, r, e[f + 10], d, 38016083),
                    r = h(r, u, t, i, e[f + 15], g, 3634488961),
                    i = h(i, r, u, t, e[f + 4], nt, 3889429448),
                    t = h(t, i, r, u, e[f + 9], k, 568446438),
                    u = h(u, t, i, r, e[f + 14], d, 3275163606),
                    r = h(r, u, t, i, e[f + 3], g, 4107603335),
                    i = h(i, r, u, t, e[f + 8], nt, 1163531501),
                    t = h(t, i, r, u, e[f + 13], k, 2850285829),
                    u = h(u, t, i, r, e[f + 2], d, 4243563512),
                    r = h(r, u, t, i, e[f + 7], g, 1735328473),
                    i = h(i, r, u, t, e[f + 12], nt, 2368359562),
                    t = c(t, i, r, u, e[f + 5], tt, 4294588738),
                    u = c(u, t, i, r, e[f + 8], it, 2272392833),
                    r = c(r, u, t, i, e[f + 11], rt, 1839030562),
                    i = c(i, r, u, t, e[f + 14], ut, 4259657740),
                    t = c(t, i, r, u, e[f + 1], tt, 2763975236),
                    u = c(u, t, i, r, e[f + 4], it, 1272893353),
                    r = c(r, u, t, i, e[f + 7], rt, 4139469664),
                    i = c(i, r, u, t, e[f + 10], ut, 3200236656),
                    t = c(t, i, r, u, e[f + 13], tt, 681279174),
                    u = c(u, t, i, r, e[f + 0], it, 3936430074),
                    r = c(r, u, t, i, e[f + 3], rt, 3572445317),
                    i = c(i, r, u, t, e[f + 6], ut, 76029189),
                    t = c(t, i, r, u, e[f + 9], tt, 3654602809),
                    u = c(u, t, i, r, e[f + 12], it, 3873151461),
                    r = c(r, u, t, i, e[f + 15], rt, 530742520),
                    i = c(i, r, u, t, e[f + 2], ut, 3299628645),
                    t = l(t, i, r, u, e[f + 0], ft, 4096336452),
                    u = l(u, t, i, r, e[f + 7], et, 1126891415),
                    r = l(r, u, t, i, e[f + 14], ot, 2878612391),
                    i = l(i, r, u, t, e[f + 5], st, 4237533241),
                    t = l(t, i, r, u, e[f + 12], ft, 1700485571),
                    u = l(u, t, i, r, e[f + 3], et, 2399980690),
                    r = l(r, u, t, i, e[f + 10], ot, 4293915773),
                    i = l(i, r, u, t, e[f + 1], st, 2240044497),
                    t = l(t, i, r, u, e[f + 8], ft, 1873313359),
                    u = l(u, t, i, r, e[f + 15], et, 4264355552),
                    r = l(r, u, t, i, e[f + 6], ot, 2734768916),
                    i = l(i, r, u, t, e[f + 13], st, 1309151649),
                    t = l(t, i, r, u, e[f + 4], ft, 4149444226),
                    u = l(u, t, i, r, e[f + 11], et, 3174756917),
                    r = l(r, u, t, i, e[f + 2], ot, 718787259),
                    i = l(i, r, u, t, e[f + 9], st, 3951481745),
                    t = o(t, ht),
                    i = o(i, ct),
                    r = o(r, lt),
                    u = o(u, at);
