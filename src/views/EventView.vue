<template>
  <div
    v-if="event"
    class="grid md:grid-cols-[2fr_1fr] gap-x-24 gap-y-8 items-start"
  >
    <div>
    ...
    <div>
      ...
      <div v-if="event.organizer" class="mt-8 grid gap-3">
  ...
  <div class="mt-12 pt-6 border-t border-[--agd-color-depth-dark]">
    <RouterLink :to="{ name: 'events' }" class="flex items-center gap-3 mb-6">
